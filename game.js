...
function itemHandler(player, item) {
 ...
 // when the player hits a bottle of poision they lose one life 
...
// when the lives became 0 the game is over 
   if (lives === 0) {
	   gameOver = true;
  } 
}
...
window.onload = function () {
  ...
  function create() {
	...
	text1 = game.add.text(600, 16, "LIVES: " + lives, { font: "bold 24px Arial", fill: "white" }); 
    winningMessage = game.add.text(game.world.centerX, 275, "", { font: "bold 48px Arial", fill: "white" });
    winningMessage.anchor.setTo(0.5, 1);
	finalMessage = game.add.text(game.world.centerX, 455, "", { font: "bold 48px Arial", fill: "white" });
